...
export const getAllCourses = async () => {
  ...
  const { }= useViewCourseStore.getState();
...
export const fetchCourseDetails = async (courseId:any) => {
  // const toastId = toast.loading("Loading...")
...
export const addCourseDetails = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
export const editCourseDetails = async (data:any, token:string) => {
  ...
  try {
    ...
    result = response?.data?.data;
    console.log(" result edit course details", result);
...
// create a section
export const createSection = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
// create a subsection
export const createSubSection = async (data:any, token:any) => {
  let result = null;
...
// update a section
export const updateSection = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
// update a subsection
export const updateSubSection = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
// delete a section
export const deleteSection = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
// delete a subsection
export const deleteSubSection = async (data:any, token:any) => {
  let result = null;
  const toastId = toast.loading("Loading...");
  try {
...
export const fetchInstructorCourses = async (token:any) => {
  let result = [];
  const toastId = toast.loading("Loading...");
  try {
...
// delete a course
export const deleteCourse = async (data:any, token:any) => {
  const toastId = toast.loading("Loading...");
  try {
...
export const getFullDetailsOfCourse = async (courseId:any, token:any) => {
  const toastId = toast.loading("Loading...");
...
export const addCourseToCategory = async (data:any, token:any) => {
  const toastId = toast.loading("Loading...");
  let success = false;
  try {
    const response = await apiConnector(
...
//search courses
export const searchCourses = async (searchQuery:any) => {
  // const toastId = toast.loading("Loading...")
  const {setProgress} =useLoadingBarStore.getState();
  setProgress(50);
  let result = null;
...
//create category
export const createCategory = async (data:any, token:any) => {
  const toastId = toast.loading("Loading...");
  let success = false;
  try {
