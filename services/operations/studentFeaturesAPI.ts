...
export async function buyCourse (token:string, courses:any, userDetails:any, navigate: (path: string) => void) {
...
async function sendPaymentSuccessEmail (response:any,amount:any,token:string) {
    // const data = {
    //     amount,
...
async function verifypament (response:any,courses:any,token:string,navigate: (path: string) => void) {
