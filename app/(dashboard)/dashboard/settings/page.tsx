...
console.log("user  ",user);
  ...
  const handelAdditionalDetails = (e:any) => {
    e.preventDefault()
  ...
  const onDeleteAccount = () => {
    if(window.confirm
      ("Are you sure you want to delete your account?")){
        deleteAccount(token,navigate.push);
      }
      ...
      <div className=' flex-1 overflow-auto'>
        ...
        <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 md:p-8 md:px-12 px-3 py-3 text-richblack-5'>
          <div className='flex items-center gap-x-4'>
            ...
            <input id='upload' type="file" onChange={handleFileChange} className="hidden" accept="image/png, image/gif, image/jpeg image/jpg"/></label>
                ...
                <div className="flex flex-col gap-5 lg:flex-row">
                  <div className="flex flex-col gap-2 lg:w-[48%]">
                    ...
                    <div className="flex flex-col gap-2 lg:w-[48%]">
                      ...
                      <select defaultValue={user?.additionalDetails.gender || null} name="gender" id="gender" className="form-style" onChange={handleOnChange}>
